...
const HeaderIndex = () => {
  ...
  const [iconClass, setIconClass] = useState('lordIcon');
    ...
    const handleWindowScroll = () => {
      if (div.current) {
        if (window.scrollY >= 40) {
          ...
          setIconClass('lordIcon');
        } else {
          div.current.classList.remove(styles.fixed);
          setIconClass('lordIcon index');
        }
      }
    };
        ...
        return (
          ...
          >
            {item.path && (
              <NavLink
                to={item.path}
                className={(navLink) => (navLink.isActive ? styles.navItem + ' ' + styles.active : styles.navItem)}
              >
                {item.name}
              </NavLink>
            )}
        ...
        >
          ...
          <Col>
            <div className={styles.icons}>
              ...
              <div className={styles.icon}>
                <HeaderUserMenu iconClass={iconClass} />
              </div>
              <div className={styles.icon}>
                <HeaderFavoriteMenu iconClass={iconClass} />
              </div>
              <div className={styles.icon}>
                <HeaderCartMenu iconClass={iconClass} />
              </div>
